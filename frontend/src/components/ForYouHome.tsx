...
return(
    <div>
                  <div className="flex justify-between sm:items-center py-5">
            <h1 className="text-xl sm:text-3xl font-medium mb-10">Dành cho bạn</h1>
            <Link to={""} className="flex h-full">
              <p className="text-base mr-2">Xem tất cả</p>
              <img src={expandTopRight} alt="expand top right" />
            </Link>
          </div>
          <div className=" sm:items-center justify-between overflow-auto ">
          ...
          <ul className="flex justify-center sm:items-center">
