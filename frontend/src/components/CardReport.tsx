...
const CardReport = ({img, title, price, area, address, date, vote}:CardReportProps) =>{
      ...
      <Card className="h-full overflow-hidden border-none"  >
         <img src={img} alt="img" className="rounded-t-lg h-60 w-full object-cover object-center" />
          <div className="p-3 space-y-2">
            ...
            <CardDescription className="text-[--orange-primary] font-medium">{price} - {area} m²</CardDescription>
